I have simulated the 2D using model in python using the metropolis algorithm.<br/><br/>
...
This temperature dependent behaviour can be seen in the 'Average Equilibrium Spin, Energy Plot' image. 
