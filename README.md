I have simulated the 2D Ising model in python using the metropolis algorithm. This is a mathematical model of the atoms in a ferromagnetic material.<br/><br/>
